            ...
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">
                    	<c:if test="${optype eq 'create' }">Add Vendor</c:if>
                    	<c:if test="${optype eq 'edit' }">Edit Vendor</c:if> 
                    </h2>
                </div>
            </header>
            <!-- Breadcrumb-->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    <h3 class="h4">
                                    	<c:if test="${optype eq 'create' }">Add Vendor Detail</c:if>
                    					<c:if test="${optype eq 'edit' }">Edit Vendor Detail</c:if> 
                                    </h3>
                                </div>
                                <div class="card-body">
                                    <form:form class="form-horizontal" autocomplete="off" method="post" action="/vendor/submitVendor" modelAttribute="vendorDTO">
                                        <form:hidden path="id" />
                                        
                                        <spring:bind path="name">
          										<div class="form-group row ${status.error ? 'has-error' : ''}">
               										<label class="col-sm-3 form-control-label">Vendor name</label>
                                           			<div class="col-sm-9">
                                                		<form:input path="name" id="name" name="name" type="text" placeholder="Vendor Name" class="form-control form-control-success"/>
                                        ...
                                        <div class="line"></div>
                                      	...
                                      	<spring:bind path="fax">
          										<div class="form-group row ${status.error ? 'has-error' : ''}">
                                           			...
                                           			<div class="col-sm-9">
                                                		<form:input path="fax" id="fax" name="fax" type="text" placeholder="Fax" class="form-control form-control-success"/>
               											<form:errors path="fax" cssClass="error"></form:errors>
                                           			</div>
           										</div>
       									</spring:bind>
